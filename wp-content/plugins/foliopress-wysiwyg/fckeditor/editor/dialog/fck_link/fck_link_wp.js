...
function LoadSelection()
{
	...
	if ( sProtocol )
	{
		...
		*/	
		...
		{
			sType = 'url' ;
		///* Modification 2001/03/07 
		/* 
		GetE('txtUrl').value = sUrl ;
		*/
		 var hWnd =  GetE('link_iframe').contentWindow.document;
		 url = hWnd.getElementById('url-field');
		 url.value = sUrl;
		///* end of modification **/
		}
	}
	...
	*/
	var hWnd =  GetE('link_iframe').contentWindow.document;
	title = hWnd.getElementById('link-title-field');
	title.value = oLink.title ;
	///* end of modification */
...
function Ok()
{
	...
	switch ( GetE('cmbLinkType').value )
	{
		...
		*/
        /// Modification    0.9.19
		 //var wnd =  GetE('link_iframe').contentDocument;
         var wnd =  GetE('link_iframe').contentWindow.document;
         ///    End of modification
		 url = wnd.getElementById('url-field');
		 url = url.value;
		 sUri = url;
			if ( url.length == 0 )
	...
	for ( var i = 0 ; i < aLinks.length ; i++ )
	{
	 ...
	 var hWnd =  GetE('link_iframe').contentWindow.document;
		...
		*/
		SetAttribute( oLink, 'title'	, title.value ) ;
		///* end of modification */
